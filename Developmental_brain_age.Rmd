...
mkdir -p Developmental_BrainAGEBrainAGE
cd /path/to/your/Developmental_BrainAGE
...
tree Developmental_BrainAGE_BrainAGE
```
...
mv ~/Downloads/Developmental_BrainAGE_template.xlsx Developmental_BrainAGE/
mv ~/Downloads/demographics.tsv Developmental_BrainAGE/

# Move freesurfer files into subfolder
mv ~/Downloads/lh.Schaefer2018_1000Parcels.*.tsv Developmental_BrainAGE/Freesurfer_Outputs/
mv ~/Downloads/rh.Schaefer2018_1000Parcels.*.tsv Developmental_BrainAGE/Freesurfer_Outputs/
```
# Load Files
...
template_brainage <- read_excel("Developmental_BrainAGE_template.xlsx")
...
# Set the path to your demographic data file
demographic_df <- read_tsv("demographics.tsv")
